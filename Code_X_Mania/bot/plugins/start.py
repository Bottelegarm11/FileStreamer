       ...
       await b.send_message(chat_id=m.chat.id,text="HELLO",quote=True)
                ...
                await b.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("Developer", url=f"https://t.me/Bigbrolucifer")
                            ]
                        ]
                    ),
                    parse_mode="markdown",
...
async def start(b, m):
    ...
    if usr_cmd == "start" or "/start":
            ...
            try:
                ...
                if user.status == "kicked":
                 ...
                 await StreamBot.send_photo(
                    chat_id=m.chat.id,
                    photo="https://telegra.ph/file/814014240fc37d01e305f.jpg",
        ...
        await StreamBot.send_photo(
            chat_id=m.chat.id,
            photo ="https://telegra.ph/file/70bf5a29651ca90d95d7e.jpg",
            caption ="""Hi !
...
Send me any file and get a direct download link and streamable link.!""",
        ...
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ** ",
                    parse_mode="markdown",
                    disable_web_page_preview=True)
                return
        ...
        try:
            ...
            if user.status == "kicked":
                await bot.send_message(
                    ...
                    text="<i>First Login using login command </i>",
                    parse_mode="HTML",
                    disable_web_page_preview=True
                )
                return
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ .",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ DEV", url="https://t.me/Bigbrolucifer")],
                [InlineKeyboardButton("💥 FOLLOW", url="https://t.me/{var.UPDATES_CHANNAL}")]
            ]
        )
    )
